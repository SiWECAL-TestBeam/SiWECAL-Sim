...
def writeCommonStuff(config):
    ...
    print('<info name="SiW-TB-2021_conf'+str(config)+'_v03"')
    ...
    print('</readouts>')
    print('<detectors>')
    print('<detector name="EcalTestBeam" type="CaloPrototype_v03" vis="EcalVis" id="3" readout="SiEcalCollection" insideTrackingVolume="false">')
