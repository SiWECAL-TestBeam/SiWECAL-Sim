#ifndef ShapedConversionProcessor_HH
#define ShapedConversionProcessor_HH 1
...
namespace CALICE
{
  ...
  */
  ...
  class ShapedConversionProcessor : public Processor {
  ...
  public:
    ...
    virtual Processor*  newProcessor() { return new ShapedConversionProcessor ; }

    /**Constructor
    */
    ShapedConversionProcessor() ;
    ...
    */
    ...
    /* Fit functions */
    virtual void fitGauss(TH1F* h);
    virtual void fitLandau(TH1F* h);
    virtual void fitLanGauss(TH1F* h);
  ...
  protected:
    ...
    TFile* _rootout;
    // TDirectory* _dir_params, _dir_cells;
    TDirectory *_dir_params, *_dir_cells;
    // Prototype for having those as ttrees
    // TTree* _fitParams;
    // // TTree _fitParams;
    // double _gauss_c, _gauss_mu, _gauss_sigma;
    // double _landau_c, _landau_mpv, _landau_mpv_cor, _landau_sigma;
    // double _langauss_c;
    // double _chi2ndf;
