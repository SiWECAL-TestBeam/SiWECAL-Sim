...
namespace CALICE
{
  ...
  ConversionProcessor aConversionProcessor;

  ConversionProcessor::ConversionProcessor() : Processor("ConversionProcessor")
  {
  ...
  void ConversionProcessor::init()
  {
    ...
    // for conf0
    _landau_mpv = TH1F("landau_mpv", "Landau MPV distribution", 400, 0.00005, 0.00015);
    _landau_mpv_cor = TH1F("landau_mpv_cor", "Landau Corrected MPV distribution", 400, 0.00005, 0.00015);
    _landau_sigma = TH1F("landau_sigma", "Landau sigma distribution", 100, 0., 0.00004);
  ...
  /************************************************************************************/
  void ConversionProcessor::processRunHeader( LCRunHeader* run)
  {
    _nRun++ ;
  }

  void ConversionProcessor::processEvent( LCEvent * evt )
  {
  ...
  void ConversionProcessor::check( LCEvent * evt ) {
    // nothing to check here - could be used to fill checkplots in reconstruction processor
  }

  /************************************************************************************/
  void ConversionProcessor::end(){
  ...
  /************************************************************************************/
  void ConversionProcessor::printParameters(){
  ...
  void ConversionProcessor::fitGaus(TH1F* h)
  {
  ...
  double ConversionProcessor::langaufun(double *x, double *par)
  {
    //Fit parameters:
  ...
  TF1* ConversionProcessor::langaufit(TH1F *his, double *fitrange, double *startvalues, double *parlimitslo, double *parlimitshi, double *fitparams, double *fiterrors, double *ChiSqr, int *NDF)
  ...
  void ConversionProcessor::fitLanGaus(TH1F* h)
  {
